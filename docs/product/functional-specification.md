...
- PERSIST.1 permanece planificado y no inicia antes de
  MANT.2 R2 → #166 → VER.2 → DOC.4 → #142/derivados.
...
[Índice de documentación](../README.md) · [Normativa](../regulatory/regulatory-framework.md) · [Fuentes oficiales](../regulatory/regulatory-sources.md)
...
**RF-064.** Las ambigüedades o decisiones interpretativas deben quedar registradas en `docs/decisions/README.md`.
