...
**Estado:** Vigente
**Versión de aplicación:** `0.1.10.01-beta` — G110/E01 aceptado; reconciliación viva hasta G110
...
| Ledger reconciliado | `data/pre-1-0-revision-ledger.json` | pruebas VER.2/NOR.2 + auditoría post-G070 | G110 aceptado; G111 disponible para DOC.2 |
