...
| TR-003 | Datos históricos y proyectados permanecen separados | N/A — integridad de datos | ADR-006, ADR-073 | `app/services/linea_tiempo.py`, `app/services/resultados.py` | `tests/test_linea_tiempo.py`, `tests/test_resultados.py` | Verificado |
...
| TR-011 | Trazabilidad explica el resultado y no recalcula | N/A — arquitectura/auditoría | ADR-042, ADR-043 | `app/models/trazabilidad.py`, `app/services/trazabilidad.py` | `tests/test_trazabilidad.py` | Verificado |
