...
La ruta `/metodologia` constituye el punto central visible de consulta normativa. Reutiliza las URLs versionadas en `regulations/*.json`, las agrupa por sistema y mantiene separadas las fuentes legales, reglamentarias, de orientación y los recursos de verificación individual.
