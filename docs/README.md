...
**Última actualización transversal:** NOR.2 R4 — migración de documentación viva — 2026-08-24
...
**Revisión activa:** NOR.2 R4 — migración y normalización de documentación viva.
...
- **NOR.2 R4:** activo; documentación viva migrada a áreas canónicas.
- **NOR.2 R5:** siguiente revisión; archivo y consolidación de documentación histórica.
