...
**Siguiente candidato disponible:** `0.1.12.01-beta` — PERSIST.1
...
- G111/E01 (`0.1.11.01-beta`) quedó aceptado para DOC.2 mediante PR #87 y merge `1041b59`. G112/E01 (`0.1.12.01-beta`) queda disponible para PERSIST.1.
...
DOC.2 R1 superó gate local, commit firmado, PR #87, CI remota, integración y revalidación post-merge; queda aceptado como G111/E01. La sincronización post-merge materializa ese mismo estado en `VERSION`; **no consume G112**.

| Global | ID revision-aware candidato | Bloque | Condición |
|---:|---|---|---|
| G112 | `0.1.12.01-beta` | PERSIST.1 — persistencia voluntaria y segura | definición de alcance + implementación aprobada + gate + commit firmado + PR/CI + integración |

G112 permanece disponible y no se considera aceptado hasta completar el gate propio de PERSIST.1.
