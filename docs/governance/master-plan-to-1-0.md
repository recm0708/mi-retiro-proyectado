...
**Versión transversal vigente:** `0.1.11.01-beta` — G111/E01 aceptado para DOC.2
**Fecha:** 2026-08-25
...
REL.GOV.1 superó gate, PR/CI e integración y consumió G110; la promoción PR #86 publicó `v0.1.10.01-beta`. DOC.2 R1 superó gate, PR #87, CI, integración y revalidación post-merge, por lo que G111/E01 (`0.1.11.01-beta`) queda aceptado; G112/E07 (`0.1.12.07-beta`) queda reservado para NOR.1 R8 antes de PERSIST.1.

### 8. DOC.2 — CHANGELOG detallado `0.0.1-beta`–`0.0.21-beta`

**Estado:** cerrado en R1 como G111/E01 (`0.1.11.01-beta`) mediante PR #87; reconstrucción de 21 estados/80 commits aceptada y revalidada post-merge. NOR.1 R8 reserva G112/E07 antes de PERSIST.1.
