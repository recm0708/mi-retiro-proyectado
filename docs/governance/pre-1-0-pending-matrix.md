...
**Versión base:** `0.1.15.04-beta` — G115/E04
**Checkpoint candidato:** DOC.1 R5 — G116/E05 (`0.1.16.05-beta`) reservado, no aceptado
...
1. `VERSION` materializa `0.1.15.04-beta` después de aceptar DOC.1 R4.
2. G116/E05 (`0.1.16.05-beta`) queda reservado para DOC.1 R5; REL.GOV.1 R2 permanece a continuación sin Global preasignado.
...
| 3 | **DOC.1 R5** | Normalización documental integral post-G115 | Reconciliar publicación G115, humanizar navegación Markdown, completar estándares/plantillas y añadir controles de regresión sin reescribir historia. | **Candidato G116/E05** |
| 4 | **REL.GOV.1 R2** | Automatización de Releases y checks | Estandarizar release notes, `gh release create`, verificación de tag/firma y lectura correcta de Actions/checks. | Siguiente checkpoint planificado |
