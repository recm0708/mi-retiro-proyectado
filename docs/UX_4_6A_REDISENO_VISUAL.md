...
**Estado:** trasladado durante GOV.1.3 R1

La bitácora completa se conserva en:

[`archive/ux/UX_4_6A_REDISENO_VISUAL.md`](archive/ux/UX_4_6A_REDISENO_VISUAL.md)
...
Consultar [`INDICE.md`](INDICE.md) para la documentación actual.
