...
- `VERSION` contiene `0.1.26.01-beta` y corresponde al estado publicado PLAN.2 R2 / G126-E01.
...
- MANT.2 R2/#206 es la fase activa sin Global, `revision_aware` ni edición preasignados.
