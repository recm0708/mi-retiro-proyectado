...
- `VERSION` contiene `0.1.26.01-beta` y corresponde a PLAN.2 R2 / G126-E01.
- G125/E01 está integrado y publicado mediante tag firmado
  `v0.1.25.01-beta` y GitHub Release prerelease 388866555.
- G127 es el siguiente Global disponible, **sin candidato ni bloque reservado**.
- PLAN.2 R2/#155 está aceptado localmente como G126/E01 (`0.1.26.01-beta`) y pendiente de publicación; `global_revision=126` y `revision_aware=0.1.26.01-beta` pertenecen al estado materializado.
- G127/current_candidate permanece libre, sin bloque, `global_revision`, `revision_aware` ni edición preasignados.
