...
class TestG113PromotionPostMerge(unittest.TestCase):
    ...
    def test_documentacion_preserva_g113_y_doc1_r3(self):
        for rel in ("README.md","RELEASES.md","VERSIONING.md","GOVERNANCE.md","SECURITY.md","docs/README.md","docs/governance/master-plan-to-1-0.md","docs/governance/roadmap.md","docs/governance/pre-1-0-revision-ledger.md"):
            text=(ROOT/rel).read_text(encoding="utf-8"); self.assertIn("G113",text); self.assertIn("DOC.1 R3",text)
