...
class TestG113PromotionPostMerge(unittest.TestCase):
    ...
    def test_ledger_acepta_doc1_r3_y_reserva_persist1(self):
    ...
    def test_registro_cierra_doc1_y_reserva_persist1(self):
        ...
        self.assertEqual("PERSIST.1", c["block"])
        self.assertEqual("R1", c["revision"])
        self.assertEqual(1, c["edition"])
        self.assertEqual("REP.1", c["next_functional_block_if_accepted"])

    def test_documentacion_declara_g113_y_persist1(self):
        files = (
