...
class TestGov16ControlesGithub(unittest.TestCase):
    ...
    def test_documento_auditoria_registra_controles(self):
        ...
        self.assertTrue((ROOT/'CODE_OF_CONDUCT.md').is_file()); self.assertTrue((ROOT/'SUPPORT.md').is_file()); self.assertTrue((DOCS/'AUDITORIA_REPOSITORIO_2026-08-18.md').is_file())
