...
class TestAccesibilidadUX4(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.js = (ROOT / "app/static/shared/js/accessibility.js").read_text(encoding="utf-8")
        cls.css = (ROOT / "app/static/shared/css/accessibility.css").read_text(encoding="utf-8")

    def test_base_carga_recursos_globales_de_accesibilidad(self):
        respuesta = self.cliente.get("/")

        self.assertEqual(respuesta.status_code, 200)
        self.assertIn("/static/shared/css/accessibility.css", respuesta.text)
        self.assertIn("/static/shared/js/accessibility.js", respuesta.text)
