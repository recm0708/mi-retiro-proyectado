...
class TestIdentidadVisualPreR8(unittest.TestCase):
    ...
    def test_plantilla_global_declara_favicons_y_apple_touch(self):
        ...
        self.assertIn("/shared/img/brand/favicon.ico", contenido)
        self.assertIn("/shared/img/brand/favicon-32x32.png", contenido)
        self.assertIn("/shared/img/brand/favicon-16x16.png", contenido)
        self.assertIn("/shared/img/brand/apple-touch-icon.png", contenido)

    def test_navbar_usa_logo_oficial_y_no_marcador_mr(self):
        contenido = (ROOT / "app/templates/asegurado/base.html").read_text(encoding="utf-8")
        self.assertIn("/shared/img/brand/logo-mark-128.png", contenido)
    ...
    def test_capa_css_de_marca_es_tematica_y_no_duplica_logica(self):
        contenido = (ROOT / "app/static/shared/css/brand.css").read_text(encoding="utf-8")
