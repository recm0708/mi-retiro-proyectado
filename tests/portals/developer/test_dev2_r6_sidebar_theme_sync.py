...
class TestDev2R6SidebarThemeSync(unittest.TestCase):
    ...
    def test_developer_deriva_colores_del_sistema_global(self):
        css = (
            ROOT
            / "app/static/developer/css/developer-portal.css"
        ).read_text(
            encoding="utf-8"
        )
    ...
    def test_sistema_global_contiene_estados_semanticos(self):
        css = (
            ROOT
            / "app/static/shared/css/design-system.css"
        ).read_text(
            encoding="utf-8"
        )
    ...
    def test_theme_js_es_compartido(self):
        js = (
            ROOT / "app/static/shared/js/theme.js"
        ).read_text(
            encoding="utf-8"
        )
    ...
    def test_sidebar_persiste_solo_preferencia_visual(self):
        js = (
            ROOT
            / "app/static/developer/js/developer_portal.js"
        ).read_text(
            encoding="utf-8"
        )
