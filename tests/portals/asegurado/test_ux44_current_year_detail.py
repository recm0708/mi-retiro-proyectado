...
class TestUX44DetalleAnioActual(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.js = (ROOT / "app/static/asegurado/js/current_year_detail.js").read_text(
            encoding="utf-8"
        )
        cls.retiro = (ROOT / "app/static/asegurado/js/retirement.js").read_text(
            encoding="utf-8"
        )
        cls.historial = (ROOT / "app/static/asegurado/js/salary_history.js").read_text(
            encoding="utf-8"
        )
