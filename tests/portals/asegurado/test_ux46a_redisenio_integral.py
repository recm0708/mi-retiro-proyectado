...
TEMA = ROOT / "app/static/shared/js/theme.js"
...
class TestUX46aRedisenioIntegral(unittest.TestCase):
    ...
    def test_capa_visual_se_carga_entre_base_y_accesibilidad(self):
        style_pos = self.base.index("path='/asegurado/css/style.css'")
        design_pos = self.base.index("path='/shared/css/design-system.css'")
        a11y_pos = self.base.index("path='/shared/css/accessibility.css'")
