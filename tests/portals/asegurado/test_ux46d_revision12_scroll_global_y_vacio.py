...
class TestUX46DRevision12ScrollGlobalYVacio(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.historial = (ROOT / "app/templates/asegurado/partials/salary_history.html").read_text(encoding="utf-8")
        cls.historial_js = (ROOT / "app/static/asegurado/js/salary_history.js").read_text(encoding="utf-8")
        cls.comparar = (ROOT / "app/templates/asegurado/comparison.html").read_text(encoding="utf-8")
