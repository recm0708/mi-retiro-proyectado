...
JS_ASEGURADO = STATIC / "asegurado" / "js"
JS_SHARED = STATIC / "shared" / "js"
DOCS = ROOT / "docs"
...
class TestUX46eAlmacenamientoComentariosJS(unittest.TestCase):
    ...
    def test_tema_y_borrado_integral_comparten_clave(self):
        tema = (JS_SHARED / "theme.js").read_text(encoding="utf-8")
        gestion = (JS_ASEGURADO / "data_management.js").read_text(encoding="utf-8")
    ...
    def test_simulacion_comparador_privacidad_y_gestion_comparten_namespace(self):
        archivos = {
            nombre: (JS_ASEGURADO / nombre).read_text(encoding="utf-8")
            for nombre in (
                "simulation.js",
                "comparator.js",
                "privacy.js",
