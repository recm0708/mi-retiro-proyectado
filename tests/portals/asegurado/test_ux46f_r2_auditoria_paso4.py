...
class TestUX46fR2AuditoriaPaso4(unittest.TestCase):
    ...
    def test_06_salario_mensual_futuro_se_transporta_sin_reconstruir(self):
        ...
        js = (ROOT / "app/static/asegurado/js/timeline.js").read_text(encoding="utf-8")
    ...
    def test_09_interfaz_explica_compuesto_y_futuro_conocido(self):
        ...
        simulacion_js = (ROOT / "app/static/asegurado/js/simulation.js").read_text(encoding="utf-8")
    ...
    def test_10_ajuste_desde_retiro_actualiza_procedencia_y_borrador(self):
        retiro = (ROOT / "app/static/asegurado/js/retirement.js").read_text(encoding="utf-8")
        simulacion = (ROOT / "app/static/asegurado/js/simulation.js").read_text(encoding="utf-8")
    ...
    def test_12_escenarios_inicia_sin_porcentajes_predeterminados(self):
        plantilla = (ROOT / "app/templates/asegurado/simulation.html").read_text(encoding="utf-8")
        javascript = (ROOT / "app/static/asegurado/js/simulation.js").read_text(encoding="utf-8")
