...
class TestUX46DRevision18ProcedenciaPersistencia(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.importacion_js = (ROOT / "app/static/asegurado/js/official_data_import.js").read_text(encoding="utf-8")
        cls.detalle_js = (ROOT / "app/static/asegurado/js/current_year_detail.js").read_text(encoding="utf-8")
        cls.historial_js = (ROOT / "app/static/asegurado/js/salary_history.js").read_text(encoding="utf-8")
        cls.css = (ROOT / "app/static/shared/css/design-system.css").read_text(encoding="utf-8")
