...
ORQUESTACION = ROOT / "app" / "static" / "asegurado" / "js" / "results_orchestration.js"
ESTILOS = ROOT / "app" / "static" / "asegurado" / "css" / "results.css"
...
class TestUX46hR1ResultadosExportacion(unittest.TestCase):
    ...
    def test_01_loader_carga_orquestacion_del_paso_6(self):
        self.assertIn("/asegurado/js/results_orchestration.js", self.loader)
    ...
    def test_02_orquestacion_carga_css_solo_al_existir_paso_6(self):
        self.assertIn("/static/asegurado/css/results.css", self.js)
