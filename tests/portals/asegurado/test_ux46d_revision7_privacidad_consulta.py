...
class TestUX46DRevision7PrivacidadConsulta(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.privacidad = (ROOT / "app/static/asegurado/js/privacy.js").read_text(encoding="utf-8")
    ...
    def test_modal_y_controlador_de_privacidad_son_globales_y_unicos(self):
        ...
        self.assertEqual(self.base.count("/asegurado/js/privacy.js"), 1)
        self.assertNotIn('partials/privacy_consent.html', self.simulacion)
        self.assertNotIn("/asegurado/js/privacy.js", self.simulacion)
