...
class UX46fR11BloqueoDocumentalTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.procedencia = leer("app/static/asegurado/js/editable_provenance.js")
        cls.importacion = leer("app/static/asegurado/js/official_data_import.js")
        cls.historial = leer("app/static/asegurado/js/salary_history.js")
        cls.detalle = leer("app/static/asegurado/js/current_year_detail.js")
        cls.simulacion = leer("app/static/asegurado/js/simulation.js")
        cls.css = leer("app/static/asegurado/css/editable-provenance.css")
        cls.design = leer("app/static/shared/css/design-system.css")
