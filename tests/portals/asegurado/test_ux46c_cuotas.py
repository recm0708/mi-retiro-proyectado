...
SIMULACION_JS = ROOT / "app/static/asegurado/js/simulation.js"
IMPORTACION_JS = ROOT / "app/static/asegurado/js/official_data_import.js"
NAVEGACION_JS = ROOT / "app/static/asegurado/js/wizard_navigation.js"
DESIGN = ROOT / "app/static/shared/css/design-system.css"
...
class TestUX46CCuotas(unittest.TestCase):
    ...
    def test_campos_editables_usan_pistas_que_desaparecen_con_el_valor(self):
        html = SIMULACION.read_text(encoding="utf-8")
        accesibilidad = (ROOT / "app/static/shared/js/accessibility.js").read_text(encoding="utf-8")
    ...
    def test_ayuda_contextual_no_dibuja_doble_circulo(self):
        css = (ROOT / "app/static/shared/css/accessibility.css").read_text(encoding="utf-8")
