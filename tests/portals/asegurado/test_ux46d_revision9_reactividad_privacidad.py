...
class TestUX46DRevision9ReactividadPrivacidad(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.style = (ROOT / "app/static/asegurado/css/style.css").read_text(encoding="utf-8")
        cls.privacidad_js = (ROOT / "app/static/asegurado/js/privacy.js").read_text(encoding="utf-8")
        cls.terminos = (
