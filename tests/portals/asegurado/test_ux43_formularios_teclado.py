...
class TestUX43FormulariosTeclado(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.a11y = (ROOT / "app/static/shared/js/accessibility.js").read_text(encoding="utf-8")
        cls.retiro = (ROOT / "app/static/asegurado/js/retirement.js").read_text(encoding="utf-8")
