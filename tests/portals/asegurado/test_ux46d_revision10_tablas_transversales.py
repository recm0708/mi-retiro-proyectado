...
class TestUX46DRevision10TablasTransversales(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.design = (ROOT / "app/static/shared/css/design-system.css").read_text(encoding="utf-8")
        cls.accesibilidad = (ROOT / "app/static/shared/js/accessibility.js").read_text(encoding="utf-8")
        cls.simulacion_js = (ROOT / "app/static/asegurado/js/simulation.js").read_text(encoding="utf-8")
        cls.linea_tiempo_js = (ROOT / "app/static/asegurado/js/timeline.js").read_text(encoding="utf-8")
    ...
    def test_contrato_visual_no_reemplaza_semanticas_especificas(self):
        historial_js = (ROOT / "app/static/asegurado/js/salary_history.js").read_text(encoding="utf-8")
        detalle = (ROOT / "app/static/asegurado/js/current_year_detail.js").read_text(encoding="utf-8")
