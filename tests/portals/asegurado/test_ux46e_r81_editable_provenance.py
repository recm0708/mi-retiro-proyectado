...
JS = ROOT / "app/static/asegurado/js/editable_provenance.js"
CSS = ROOT / "app/static/asegurado/css/editable-provenance.css"
...
class TestUx46eR81ProcedenciaEditable(unittest.TestCase):
    ...
    def test_base_carga_capa_css_de_procedencia(self):
        self.assertIn("/asegurado/css/editable-provenance.css", self.base)

    def test_script_se_carga_despues_de_scripts_especificos(self):
        bloque = self.base.index("{% block scripts %}")
        capa = self.base.index("/asegurado/js/editable_provenance.js")
