...
class UX46fR1ConsistenciaProcedenciaAdjuntosTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.simulacion_js = leer("app/static/asegurado/js/simulation.js")
        cls.historial_js = leer("app/static/asegurado/js/salary_history.js")
        cls.detalle_js = leer("app/static/asegurado/js/current_year_detail.js")
        cls.importacion_js = leer("app/static/asegurado/js/official_data_import.js")
        cls.referencia_js = leer("app/static/asegurado/js/mi_retiro_seguro_reference.js")
        cls.procedencia_js = leer("app/static/asegurado/js/editable_provenance.js")
        cls.procesamiento_js = leer("app/static/asegurado/js/attachment_processing.js")
        cls.gestion_js = leer("app/static/asegurado/js/data_management.js")
        cls.css = leer("app/static/asegurado/css/editable-provenance.css")
        cls.design_system_css = leer("app/static/shared/css/design-system.css")
        cls.accesibilidad_js = leer("app/static/shared/js/accessibility.js")
    ...
    def test_10_helper_global_de_adjuntos_carga_antes_de_scripts_de_pagina(self):
        helper = self.base.index("/asegurado/js/attachment_processing.js")
