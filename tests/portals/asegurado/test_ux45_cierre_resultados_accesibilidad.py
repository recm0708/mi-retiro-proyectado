...
class TestUX45CierreResultadosAccesibilidad(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.resultados_js = (ROOT / "app/static/asegurado/js/results.js").read_text(
            encoding="utf-8"
        )
        cls.simulacion_js = (ROOT / "app/static/asegurado/js/simulation.js").read_text(
            encoding="utf-8"
        )
        cls.referencia_js = (
            ROOT / "app/static/asegurado/js/mi_retiro_seguro_reference.js"
        ...
        cls.css = (ROOT / "app/static/asegurado/css/style.css").read_text(encoding="utf-8")
