...
def test_r6_payloads_indirectos_conservan_campos_requeridos():
    ...
    comparator = _texto("app/static/asegurado/js/comparator.js")
    detalle = _texto("app/static/asegurado/js/current_year_detail.js")
    results = _texto("app/static/asegurado/js/results.js")
    retirement = _texto("app/static/asegurado/js/retirement.js")
...
def test_r6_como_se_calcula_anclas_dinamicas_existen():
    ...
    js = _texto("app/static/asegurado/js/results_orchestration.js")
