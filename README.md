...
- **Versión canónica vigente:** `0.1.26.01-beta`, obtenida exclusivamente desde
  [`VERSION`](VERSION); corresponde a PLAN.2 R2 / G126/E01 **publicado**.
- **Última publicación formal:** `v0.1.26.01-beta`, tag firmado sobre
  ...
  390399947.
- **Fase material actual:** **MANT.2 R2 / #206**, en curso sin Global ni
  `VERSION` preasignados.
- **Siguiente Global disponible:** G127, libre y sin candidato.
- **Preflight de entrada #166:** `BLOCKED_BY_MANT2_R2`; detectó los PRs
  Dependabot #204 y #205 antes de iniciar VER.2 R6/#164.
