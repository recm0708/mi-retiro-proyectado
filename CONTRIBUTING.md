...
- `VERSION` permanece en `0.1.26.01-beta` para el estado publicado PLAN.2 R2 / G126-E01.
- G125/E01 permanece preservado como publicación formal anterior.
- MANT.2 R2/#206 está activo sin Global/VERSION preasignados y G127 sigue libre.
